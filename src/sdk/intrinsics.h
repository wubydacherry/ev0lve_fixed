...
static const __declspec(align(16)) float _pi2[4] = {1.5707963267948966192f, 1.5707963267948966192f,
													1.5707963267948966192f, 1.5707963267948966192f};
static const __declspec(align(16)) float _pi[4] = {3.141592653589793238f, 3.141592653589793238f, 3.141592653589793238f,
												   3.141592653589793238f};
static const __declspec(align(16)) int32_t component_mask[4][4]{{(int32_t)0xFFFFFFFF, 0, 0, 0},
																{0, (int32_t)0xFFFFFFFF, 0, 0},
																{0, 0, (int32_t)0xFFFFFFFF, 0},
																{0, 0, 0, (int32_t)0xFFFFFFFF}};
