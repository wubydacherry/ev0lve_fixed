...
bool context_input::on_input(UINT msg, WPARAM w, LPARAM l)
{
	...
	static const auto mouse_from_msg = [](UINT m, WPARAM w) -> char
	{
	...
	cur_current = vec2{static_cast<float>(cur.x), static_cast<float>(cur.y)} * draw.scale;
